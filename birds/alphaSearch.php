...
<html>
	...
	?>
		...
		<tr>
			<td>
				<form method = "post" action = "wingSearch.php">
				<?php
			...
			<td>
			<?php
				echo '<h2 class="p2"><u>Search For "'.$searchTerm.'" (alphabetical)</u></h2>';
			?>
			</td>
			<td>
		...
		<?php 
			...
			$query = "select id, colloquial_name, image_path from birds where colloquial_name like '%".$searchTerm."%'";
