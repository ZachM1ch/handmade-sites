...
<header>
    <nav class="navbar">
        ...
        <button id="lang-toggle" onclick="toggleLang()" style="margin-left:auto; padding:5px 14px; font-weight:bold; cursor:pointer; border:2px solid #FAF7F2; background:transparent; color:#FAF7F2; border-radius:4px;" data-en="ES" data-es="EN">ES</button>
    </nav>
</header>
