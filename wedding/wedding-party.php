...
<section class="card">
    ...
    <div class="center-flex">
        <div class="center-box-flex">
            ...
            <div class="center-image"><img src="..\assets\images\wedding\cian.png" alt="Cian" width="400" height="500"></div>
        ...
        <div class="center-box-flex">
            ...
            <div class="center-image"><img src="..\assets\images\wedding\coming_soon.png" alt="Kristen" width="400" height="500"></div>
    ...
    <div class="center-flex">
        <div class="center-box-flex">
            <div class="center-image"><img src="..\assets\images\wedding\monica.png" alt="Monica" width="400" height="500"></div>
            <h3 data-en="Monica" data-es="Monica">Monica</h3>
            <p data-en="Placeholder bio goes here." data-es="La biografía de marcador de posición va aquí.">Placeholder
                bio goes here.</p>
        </div>
        <div class="center-box-flex">
            <div class="center-image"><img src="..\assets\images\wedding\jessica.png" alt="Jessica" width="400" height="500"></div>
            <h3 data-en="Jessica" data-es="Jessica">Jessica</h3>
            <p data-en="Placeholder bio goes here." data-es="La biografía de marcador de posición va aquí.">Placeholder
                bio goes here.</p>
        </div>
        <div class="center-box-flex">
            <div class="center-image"><img src="..\assets\images\wedding\jennifer.png" alt="Jennifer" width="400" height="500"></div>
    ...
    <div class="center-flex">
        <div class="center-box-flex">
            <div class="center-image"><img src="..\assets\images\wedding\coming_soon.png" alt="Adam" width="400" height="500"></div>
        ...
        <div class="center-box-flex">
            <div class="center-image"><img src="..\assets\images\wedding\coming_soon.png" alt="Kevin" width="400" height="500"></div>
            <h3 data-en="Kevin" data-es="Kevin">Kevin</h3>
            <p data-en="" data-es=""></p>
        </div>
        <div class="center-box-flex">
            <div class="center-image"><img src="..\assets\images\wedding\coming_soon.png" alt="Keegan" width="400" height="500"></div>
